...
public class LP3Driver {
    public static void main(String[] args) throws Exception {
        boolean useDriver = true;

        if(useDriver) {

            Scanner in;

            Boolean readHere = true;

            // create file
            FileOutputStream f = new FileOutputStream("output420.txt");
//            System.setOut(new PrintStream(f));

            if (readHere) {
//            lp3-big-200k
                File file = new File("src/ypp170130/input/lp3-big-500k.txt");
//                File file = new File("src/ypp170130/input/420.txt");
            ...
            BigDecimal d = (new BigDecimal("0.8")).multiply (new BigDecimal("0.4"));
            System.out.println(d);
            MDS.Money m1 = new MDS.Money(5, 0);
